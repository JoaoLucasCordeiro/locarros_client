...
import { FaShoppingCart, FaCar, FaMoneyBillWave, FaUserTie } from 'react-icons/fa';
    ...
    return (
        <div className='w-[450px] h-[485px] flex flex-col items-center bg-white shadow-xl rounded-2xl'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <Button className='red-bg text-white rounded-xl outline-none border-none font-base flex items-center justify-center p-2 gap-2 hover:bg-red-700 transition-all duration-300'>
                    Alugar
